...
| 3   | Data isolation and input trust            | Prove a second user cannot reach the first user's rows, and that crafted input is rejected at the boundary                                                | #4, #7           | integration + unit                          | implementing | `context/changes/testing-data-isolation-input-trust/`  |
